...
class CNN_Gender(sb.Brain):
    ...
    def compute_forward(self, batch, stage):
        ...
        feats = feats.unsqueeze(axis=1) # reshape to (batch, channel, W, H)
        predictions = self.modules.model(feats, lens)
        print(predictions)
